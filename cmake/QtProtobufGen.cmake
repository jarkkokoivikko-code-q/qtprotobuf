...
function(qtprotobuf_generate)
    ...
    if(arg_QML)
        if(NOT TARGET ${QT_VERSIONED_PREFIX}::Qml)
            message(FATAL_ERROR "Trying to enable QML support for '${generated_target_name}',"
                " but ${QT_VERSIONED_PREFIX}::Qml is not a target."
    ...
    if(QT_PROTOBUF_PROTOC_EXECUTABLE)
        set(protoc_executable ${QT_PROTOBUF_PROTOC_EXECUTABLE})
    else()
        set(protoc_executable $<TARGET_FILE:protobuf::protoc>)
    endif()

    if(CMAKE_HOST_WIN32)
        set(PROTOC_COMMAND set QT_PROTOBUF_OPTIONS=${generation_options_string}&& ${protoc_executable})
    else()
        set(PROTOC_COMMAND "QT_PROTOBUF_OPTIONS=${generation_options_string}" ${protoc_executable})
    endif()
