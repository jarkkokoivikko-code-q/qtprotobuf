...
if exist %cd%\..\openssl\openssl-android-arm64 set OPENSSL_PARAMS=-DgRPC_SSL_PROVIDER=package -DOPENSSL_ROOT_DIR=%cd%\..\openssl\openssl-android-arm64 -D_OPENSSL_NAME_POSTFIX=_arm64-v8a
